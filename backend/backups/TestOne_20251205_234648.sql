...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.alerts TO app_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.posts TO app_user;
...
GRANT ALL ON SEQUENCE public.posts_id_seq TO app_user;

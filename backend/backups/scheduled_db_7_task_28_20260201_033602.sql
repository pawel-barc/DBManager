...
--
-- Name: posts; Type: TABLE; Schema: public; Owner: app_user
--
...
ALTER TABLE public.posts OWNER TO app_user;

--
-- Name: posts_id_seq; Type: SEQUENCE; Schema: public; Owner: app_user
--
...
ALTER SEQUENCE public.posts_id_seq OWNER TO app_user;

--
-- Name: posts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: app_user
--
...
--
-- Name: posts id; Type: DEFAULT; Schema: public; Owner: app_user
--
...
--
-- Data for Name: posts; Type: TABLE DATA; Schema: public; Owner: app_user
--

COPY public.posts (id, user_id, title, content, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: posts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app_user
--
...
--
-- Name: posts posts_pkey; Type: CONSTRAINT; Schema: public; Owner: app_user
--
...
--
-- Name: posts posts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: app_user
--

      ...
      <form className="profile-form" onSubmit={formik.handleSubmit}>
        ...
        <div className="profile-container">
          ...
          <label htmlFor="username">
            ...
            {formik.touched.username && formik.errors.username ? ( // 'formik.touched' verifie si le champ a été visité par l'utilisateur
              <div className="error">{formik.errors.username}</div> // Contient les messages d'erreurs de validations pour chaque champ
            ) : null}
          </label>
          <label htmlFor="email">
            <h2>E-mail</h2>
